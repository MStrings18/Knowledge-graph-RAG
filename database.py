import sqlite3
conn = sqlite3.connect('/Users/akshitagrawal/Knowledge-graph-RAG/threads.db', check_same_thread=False)
cursor = conn.cursor()
...
class DB:
    def __init__(self):
        self.conn = sqlite3.connect('/Users/akshitagrawal/Knowledge-graph-RAG/threads.db', check_same_thread=False)
